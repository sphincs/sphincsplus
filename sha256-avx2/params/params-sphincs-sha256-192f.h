...
/* This is a SHA2-based parameter set, hence whether we use SHA-256 exclusively or we use both SHA-256 and SHA-512 is controlled by the following #define */
#define DO_SHA512 1  /* Use SHA-512 for H, T functions */
